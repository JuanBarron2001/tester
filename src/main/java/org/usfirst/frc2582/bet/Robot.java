...
public class Robot extends TimedRobot 
{
    ...
    public void robotInit() 
    {
        ...
        arm = new arm();
        //Robot.arm.zeroSensor(); //This zeros the arm when staring the robot need to make sure arm is up when starting.  Need to move this to limit switch, but is here for now
        //CameraServer.getInstance().startAutomaticCapture();
        SmartDashboard.putNumber("Foot Position", Robot.foot.getFootPosition());
    ...
    public void robotPeriodic() 
    {
        SmartDashboard.putNumber("Foot Position", Robot.foot.getFootPosition());
        SmartDashboard.putNumber("Arm Position", Robot.arm.getArmPosition());
        SmartDashboard.putNumber("Arm Angle", Robot.arm.getArmPosition());
