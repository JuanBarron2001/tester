...
public class foot extends Subsystem 
{
    ...
    */
    ...
    {
        foot1.set(ControlMode.MotionMagic, targetPosition); //uses motion magic of the foot
    }
    ...
    {
        return foot1.getSelectedSensorPosition(0);          //it returns the zero postion of the foot?
    ...
    {
        foot1.setSelectedSensorPosition(0, kPIDLoopIdx, kTimeoutMs);    //it sets the foot postion to 0
    ...
    {
        foot1.set(ControlMode.PercentOutput,0);              //it sets the foot speed to 0;
    }


    public boolean isReverseLimit()
    {
        Boolean hit = foot1.getSensorCollection().isRevLimitSwitchClosed();     //it sets the value of hit if closes the limit switch
        Robot.blinkin.limitSwitch(hit);                                         //it sets the blinkin to the value of hit
